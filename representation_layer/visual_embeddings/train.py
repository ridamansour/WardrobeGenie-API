...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_dir", default="../../data/fashionpedia_coco/train", type=str)
    parser.add_argument("--valid_dir", default="../../data/fashionpedia_coco/valid", type=str)
    parser.add_argument("--output_dir", default="../../models/visual_embedder", type=str)
