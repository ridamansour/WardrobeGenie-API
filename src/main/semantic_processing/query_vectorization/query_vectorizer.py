...
from src.main.semantic_processing.query_vectorization.model import DistilledQueryEncoder
from src.config import NLP_MODEL_DIR
...
class QueryVectorizer:
    ...
    def __init__(self, model_path=NLP_MODEL_DIR / "distilled_query_encoder.pth"):
