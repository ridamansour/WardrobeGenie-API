...
from src.config import FASHION_QUERIES_TXT_DATA, NLP_MODEL_DIR
...
def train_distillation(queries, epochs=5, batch_size=32, lr=2e-5):
    ...
    output_path = NLP_MODEL_DIR / "distilled_query_encoder.pth"
...
if __name__ == "__main__":
    ...
    with open(FASHION_QUERIES_TXT_DATA, "r") as f:
