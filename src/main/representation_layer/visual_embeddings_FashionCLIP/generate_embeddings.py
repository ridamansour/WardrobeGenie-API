...
# Note: Using CLIPProcessor handles both images and text,
# but CLIPImageProcessor works perfectly if you are only doing image embeddings.
from transformers import CLIPImageProcessor

from src.config import FASHIONOPEDIA_COCO_DIR
...
def generate_dataset_embeddings(data_root, split="train"):
    ...
    # Load Teacher and FashionCLIP Image Processor
    ...
    for ann in tqdm(data['annotations']):
        ...
        try:
            ...
            # Defensive check: Ensure bbox coordinates are integers for PIL cropping
            ...
            # Save to disk as float32 (or add .half() if you want float16 to save space)
...
if __name__ == "__main__":
    # Run for both splits
    base_path = FASHIONOPEDIA_COCO_DIR
