...
from src.config import STYLIST_BRAIN_DIR, FASHIONOPEDIA_COCO_DIR
...
def train(data_path, epochs=100, patience=7, batch_size=8):
    ...
    for epoch in range(epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            counter = 0
            torch.save(model.state_dict(), STYLIST_BRAIN_DIR / "best_stylist.pth")
...
if __name__ == "__main__":
    train(FASHIONOPEDIA_COCO_DIR / "processed_pool.pt")