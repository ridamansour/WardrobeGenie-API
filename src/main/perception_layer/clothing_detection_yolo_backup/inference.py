...
from src.main.perception_layer.clothing_detection_yolo_backup.model import load_model, CLASS_NAMES, DEVICE
from src.config import FASHIONOPEDIA_COCO_DIR, YOLO_MODEL_DIR, IMAGE_EXAMPLES_DIR
...
class GarmentDetector:
    def __init__(self, model_path: str | Path = YOLO_MODEL_DIR):
...
if __name__ == "__main__":
    ...
    example_path = IMAGE_EXAMPLES_DIR
