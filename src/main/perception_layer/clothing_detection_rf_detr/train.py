...
from src.main.perception_layer.clothing_detection_rf_detr.model import create_model, TRAIN_CONFIG, DEVICE
from src.config import FASHIONOPEDIA_COCO_DIR, MODELS_DIR
...
def parse_args():
    ...
    parser.add_argument("--dataset_dir", type=str, default=FASHIONOPEDIA_COCO_DIR)
