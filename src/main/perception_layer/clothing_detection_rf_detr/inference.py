...
from src.main.perception_layer.clothing_detection_rf_detr.model import load_model, CLASS_NAMES, DEVICE
from src.config import RF_DETR_MODEL_DIR, IMAGE_EXAMPLES_DIR
...
if __name__ == "__main__":
    detector = GarmentDetector(RF_DETR_MODEL_DIR / "checkpoint_best_ema.pth")

    # image = load_image(IMAGE_EXAMPLES_DIR/ "ex2.jpeg")
    for img_path in IMAGE_EXAMPLES_DIR.glob("*.jpeg"):
