...
from src.main.perception_layer.multi_attribute_classifier.old_model.model import MultiHeadAttributeClassifier

from src.config import ATTRIBUTE_PREDICTOR_DIR, IMAGE_EXAMPLES_DIR
...
if __name__ == "__main__":
    predictor = AttributePredictor( ATTRIBUTE_PREDICTOR_DIR / "runs/1b/best_model.pt")
    image = Image.open(IMAGE_EXAMPLES_DIR / "ex4.jpeg")
