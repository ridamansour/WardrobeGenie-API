...
if __name__ == "__main__":
    ...
    parser.add_argument("--img_dir",  default=FASHIONOPEDIA_COCO_DIR / "train")
    parser.add_argument("--ann_file", default=FASHIONOPEDIA_COCO_DIR / "train" / "_annotations.coco.json")
