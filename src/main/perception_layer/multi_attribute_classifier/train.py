...
from src.main.perception_layer.multi_attribute_classifier.model import MultiHeadAttributeClassifier
from src.main.perception_layer.multi_attribute_classifier.attribute_dataset import AttributeDataset
from src.config import ATTRIBUTE_PREDICTOR_DIR
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", default=ATTRIBUTE_PREDICTOR_DIR / "1b")
